" The original vim-nerdtree-tabs is an abandoned project, and now broken.
" This version is my hacked "fixed" version.
"
" The basic problem that broke vim-nerdtree-tabs is that an update to vim
" sometime around Jan 2023 changed the behavior of autocommands. You can no
" longer close your current buffer from within an autocmd.  See this
" discussion where we figured out how to fix it.
